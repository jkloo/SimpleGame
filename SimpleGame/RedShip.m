...
- (id)init
{
    ...
    NSArray *textures = [NSArray
        arrayWithObjects:[SKTexture textureWithImageNamed:@"RedShip0"], [SKTexture textureWithImageNamed:@"RedShip1"],
                         [SKTexture textureWithImageNamed:@"RedShip2"], [SKTexture textureWithImageNamed:@"RedShip3"],
                         [SKTexture textureWithImageNamed:@"RedShip2"], [SKTexture textureWithImageNamed:@"RedShip3"],
                         [SKTexture textureWithImageNamed:@"RedShip2"], [SKTexture textureWithImageNamed:@"RedShip1"],
                         nil];
...
{
    NSArray *textures = [NSArray
        arrayWithObjects:[SKTexture textureWithImageNamed:@"RedCrash0"], [SKTexture textureWithImageNamed:@"RedCrash1"],
                         [SKTexture textureWithImageNamed:@"RedCrash2"], [SKTexture textureWithImageNamed:@"RedCrash3"],
                         [SKTexture textureWithImageNamed:@"RedCrash3"], nil];
